	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone = partdefinition.addOrReplaceChild("bone",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 67)
						.addBox(-4.0F, -8.0F, -4.0F, 8.0F, 5.0F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition cube_r1 = bone.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(52, 54).addBox(-4.0F, -4.0F, -4.0F, 8.0F, 8.0F, 8.0F,
		...
		PartDefinition bone8 = partdefinition.addOrReplaceChild("bone8",
				CubeListBuilder.create().texOffs(0, 43)
						.addBox(10.0F, -5.5F, 10.0F, 13.0F, 11.0F, 13.0F, new CubeDeformation(0.0F)).texOffs(51, 6)
		...
		PartDefinition cube_r2 = bb_main.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(32, 67).addBox(-3.5F, -11.0F, 0.5F, 7.0F, 11.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(16.5F, -11.0F, -16.5F, -0.0873F, -0.7854F, 0.0F));

		PartDefinition cube_r3 = bb_main.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(54, 70).addBox(-3.5F, -11.0F, 0.5F, 7.0F, 11.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-16.5F, -11.0F, -16.5F, -0.0873F, 0.7854F, 0.0F));

		PartDefinition cube_r4 = bb_main.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(76, 70).addBox(-3.5F, -11.0F, 0.5F, 7.0F, 11.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-16.5F, -11.0F, 16.5F, -0.0873F, -0.7854F, 0.0F));

		PartDefinition cube_r5 = bb_main.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(0, 80).addBox(-3.5F, -11.0F, 0.5F, 7.0F, 11.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(16.5F, -11.0F, 16.5F, -0.0873F, 0.7854F, 0.0F));

		PartDefinition cube_r6 = bb_main.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(22, 82).addBox(-3.5F, -11.0F, -4.5F, 7.0F, 11.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(16.5F, -11.0F, -16.5F, 0.0873F, -0.7854F, 0.0F));

		PartDefinition cube_r7 = bb_main.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(84, 54).addBox(-3.5F, -11.0F, -4.5F, 7.0F, 11.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-16.5F, -11.0F, -16.5F, 0.0873F, 0.7854F, 0.0F));

		PartDefinition cube_r8 = bb_main.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(44, 85).addBox(-3.5F, -11.0F, -4.5F, 7.0F, 11.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-16.5F, -11.0F, 16.5F, 0.0873F, -0.7854F, 0.0F));

		PartDefinition cube_r9 = bb_main.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(66, 85).addBox(-3.5F, -11.0F, -4.5F, 7.0F, 11.0F, 4.0F,
						new CubeDeformation(0.0F)),
